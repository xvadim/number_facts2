...
import '../../domain/numbers_api_repository.dart' as _i8;
import '../../infrastructure/api/number_api_client_mock_impl.dart' as _i7;
import '../../infrastructure/api/numbers_api_client_impl.dart' as _i6;
import '../../infrastructure/api/retrofit_client.dart' as _i4;
import '../../infrastructure/numbers_api_repository_impl.dart' as _i9;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i5.NumbersApiClient>(
      _i7.NumbersApiClientMockImpl(gh<_i4.RetrofitClient>()),
      registerFor: {_test},
    );
    gh.factory<_i8.NumberApiRepository>(
        () => _i9.NumberApiRepositoryImpl(gh<_i5.NumbersApiClient>()));
    return this;
  }
}
